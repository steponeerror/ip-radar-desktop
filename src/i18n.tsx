...
const zh: Record<string, string> = {
  ...
  "abuse.usage": "用途",
  "app.title": "IP Radar",
  "app.closeHint": "隐藏到托盘，退出请用托盘菜单",
  "common.back": "返回",
  "column.city": "城市",
  "column.country": "国家",
  "column.operator": "运营商",
  "ipDetail.range": "网段",
  "ipDetail.noHits": "{n} 组分类 · 0 命中",
  "query.go": "查询",
  "query.placeholder": "输入或粘贴 IP…",
  "query.lookingUp": "查询中…",
  "query.noIp": "未识别到有效 IP",
  "query.emptyHint": "粘贴或输入 IP,回车查询",
  "settings.serverUrl": "Server 地址",
  "settings.secServer": "服务器",
  "settings.secKeys": "API Keys",
  "settings.secQuery": "查询",
  "settings.secSystem": "系统",
...
const en: Record<string, string> = {
  ...
  "abuse.usage": "Usage",
  "app.title": "IP Radar",
  "app.closeHint": "Hide to tray; use the tray menu to quit",
  "common.back": "Back",
  "column.city": "City",
  "column.country": "Country",
  "column.operator": "Operator",
  "ipDetail.range": "Range",
  "ipDetail.noHits": "{n} groups · 0 hits",
  "query.go": "Look up",
  "query.placeholder": "Paste or type an IP…",
  "query.lookingUp": "Looking up…",
  "query.noIp": "No valid IP found",
  "query.emptyHint": "Paste or type an IP, press Enter",
  "settings.serverUrl": "Server URL",
  "settings.secServer": "Server",
  "settings.secKeys": "API Keys",
  "settings.secQuery": "Query",
  "settings.secSystem": "System",
