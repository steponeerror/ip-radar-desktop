...
const INPUT_CLS =
  "w-full rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm text-zinc-200 transition-colors placeholder:text-zinc-600 focus:border-emerald-600 focus:outline-none";
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-zinc-800 p-4">
        <button
          onClick={() => void save()}
          className="w-full rounded-md bg-emerald-500 px-3 py-2 text-sm font-semibold text-zinc-950 transition hover:scale-[1.01] active:scale-[0.98]"
        >
          {t("settings.save")}
        </button>
      </div>
